 ...
 * 
 */
@WebServiceClient(name = "BusinessService", targetNamespace = "http://webservice.business.knowyourtown/", wsdlLocation = "http://127.0.1.1:6901/ws/business?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://webservice.business.knowyourtown/", "BusinessService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.1.1:6901/ws/business?wsdl");
     ...
     *     returns Business
     */
    @WebEndpoint(name = "BusinessImplementationPort")
    public Business getBusinessImplementationPort() {
        return super.getPort(new QName("http://webservice.business.knowyourtown/", "BusinessImplementationPort"), Business.class);
    }
     ...
     */
    @WebEndpoint(name = "BusinessImplementationPort")
    public Business getBusinessImplementationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.business.knowyourtown/", "BusinessImplementationPort"), Business.class, features);
    }
