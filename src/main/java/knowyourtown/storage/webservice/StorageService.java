 ...
 * 
 */
@WebServiceClient(name = "StorageService", targetNamespace = "http://webservice.storage.knowyourtown/", wsdlLocation = "http://127.0.1.1:6902/ws/storage?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STORAGESERVICE_QNAME = new QName("http://webservice.storage.knowyourtown/", "StorageService");
    ...
    public Storage getStorageImplementationPort() {
        return super.getPort(new QName("http://webservice.storage.knowyourtown/", "StorageImplementationPort"), Storage.class);
    }
    ...
    public Storage getStorageImplementationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.storage.knowyourtown/", "StorageImplementationPort"), Storage.class, features);
    }
